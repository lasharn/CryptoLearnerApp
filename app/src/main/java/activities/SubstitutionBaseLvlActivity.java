...
public class SubstitutionBaseLvlActivity extends BaseLvlActivity implements CaesarCompleteDialogFragment.Caesar1DialogListener {
...
//    private SubstitutionMessage cipherMessage;
    ...
    public SubstitutionBaseLvlActivity() {
