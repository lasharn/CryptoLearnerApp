...
/**
 * Created by Monke on 25/04/2016.
 */
/*
...
//        a.recycle();
        ...
        mBackground = getBitmapFor(R.drawable.dialer);
        mDimple = getBitmapFor(R.drawable.top);
        mDimpleDim = getBitmapFor(R.drawable.top);

        mArrowLongLeft = getBitmapFor(R.drawable.unlocked_icon);
        mArrowLongRight = getBitmapFor(R.drawable.unlocked_icon);
        mArrowShortLeftAndRight = getBitmapFor(R.drawable.unlocked_icon);
